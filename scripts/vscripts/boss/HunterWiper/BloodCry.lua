...
LinkLuaModifier("Modifier_Group_Bleed", "boss/HunterWiper/Modifier_Group_Bleed.lua", LUA_MODIFIER_MOTION_NONE)
...
function BloodCry: OnHit(target, damage, stun_time)
	...
	local stun_modifier = target:AddNewModifier(caster, self, "modifier_stunned", {duration = stun_time})
		...
		--群体血魔大
	local Modifier_Group_Bleed = target:AddNewModifier(caster, self, "Modifier_Group_Bleed", {duration = stun_time*3})
end